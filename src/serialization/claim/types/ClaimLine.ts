...
export const ClaimLine: core.schemas.ObjectSchema<ClaimLine.Raw, TpaStreamApi.claim.ClaimLine> = core.schemas.object({
  ...
  dateOfService: core.schemas.property(
    "date_of_service",
    core.schemas.lazyObject(() => serializers.claim.DateRange)
  ),
...
export declare namespace ClaimLine {
  interface Raw {
    ...
    date_of_service: serializers.claim.DateRange.Raw;
