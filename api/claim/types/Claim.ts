...
export interface Claim {
  ...
  checkDate?: string;
  checkNumber?: string;
  claimMedicalLines: TpaStreamApi.claim.ClaimLine[];
  ...
  policyHolder: TpaStreamApi.claim.PolicyHolder;
  processedOn?: string;
  ...
  status?: TpaStreamApi.claim.ClaimStatus;
  type_?: TpaStreamApi.claim.ClaimType;
  uuid?: string;
