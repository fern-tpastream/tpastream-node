...
export const Claim: core.schemas.ObjectSchema<Claim.Raw, TpaStreamApi.claim.Claim> = core.schemas.object({
  ...
  claimMedicalLines: core.schemas.property(
    "claim_medical_lines",
    core.schemas.list(core.schemas.lazyObject(() => schemas.claim.ClaimLine))
  ),
  ...
  dateOfService: core.schemas.property(
    "date_of_service",
    core.schemas.lazyObject(() => schemas.claim.DateRange).optional()
  ),
  ...
  members: core.schemas.list(core.schemas.lazyObject(() => schemas.member.Member)).optional(),
  modifieddate: core.schemas.date().optional(),
  network: core.schemas.lazy(() => schemas.claim.Network).optional(),
  ...
  policyHolder: core.schemas.property(
    "policy_holder",
    core.schemas.lazyObject(() => schemas.claim.PolicyHolder)
  ),
  ...
  status: core.schemas.lazy(() => schemas.claim.ClaimStatus).optional(),
  type_: core.schemas.property("type", core.schemas.lazyObject(() => schemas.claim.ClaimType).optional()),
...
export declare namespace Claim {
  interface Raw {
    ...
    claim_medical_lines: schemas.claim.ClaimLine.Raw[];
    ...
    date_of_service?: schemas.claim.DateRange.Raw | null;
    ...
    members?: schemas.member.Member.Raw[] | null;
    modifieddate?: string | null;
    network?: schemas.claim.Network.Raw | null;
    patient_account_number?: string | null;
    patient_name?: string | null;
    patient_payer_number?: string | null;
    patient_responsibility?: number | null;
    policy_holder: schemas.claim.PolicyHolder.Raw;
    ...
    status?: schemas.claim.ClaimStatus.Raw | null;
    type?: schemas.claim.ClaimType.Raw | null;
    uuid?: string | null;
